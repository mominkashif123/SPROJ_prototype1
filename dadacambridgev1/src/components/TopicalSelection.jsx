      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-4xl">
        {["O Level", "A Level"].map((level, index) => (
          <motion.div
            ...
            className="relative group flex flex-col items-center justify-center bg-white rounded-2xl shadow-md h-64 cursor-pointer transition-all duration-300 hover:shadow-xl"
